...
var NutrientViewFabric = forwardRef(function (props, ref) {
    ...
    useImperativeHandle(ref, function () { return ({
        ...
        convertPointToScreen: function (pageIndex, point) {
            return NativeNutrientViewTurboModule_1.default.convertPointToScreen(instanceId.toString(), pageIndex, point);
        },
        convertPointToPage: function (pageIndex, point) {
            return NativeNutrientViewTurboModule_1.default.convertPointToPage(instanceId.toString(), pageIndex, point);
        },
        convertRectToScreen: function (pageIndex, rect) {
            return NativeNutrientViewTurboModule_1.default.convertRectToScreen(instanceId.toString(), pageIndex, rect);
        },
        convertRectToPage: function (pageIndex, rect) {
            return NativeNutrientViewTurboModule_1.default.convertRectToPage(instanceId.toString(), pageIndex, rect);
        },
        getViewportState: function () {
            return NativeNutrientViewTurboModule_1.default.getViewportState(instanceId.toString());
        },
        showSignaturePad: function (requestId, allow) {
            return NativeNutrientViewTurboModule_1.default.showSignaturePad(instanceId.toString(), requestId, allow);
        },
    ...
    var fabricProps = __assign(__assign({}, props), { 
        ...
        onDocumentLoaded: props.onDocumentLoaded
            ...
            : undefined, onShouldShowSignaturePad: props.onShouldShowSignaturePad
            ? function (e) {
                var _a;
                var native = (_a = e === null || e === void 0 ? void 0 : e.nativeEvent) !== null && _a !== void 0 ? _a : e;
                props.onShouldShowSignaturePad(native);
            }
        ...
        hasShouldShowSignaturePad: !!props.onShouldShowSignaturePad, 
