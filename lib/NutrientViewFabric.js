...
var NutrientViewFabric = forwardRef(function (props, ref) {
    ...
    var fabricProps = __assign(__assign({}, props), { 
        ...
        disableDefaultActionForTappedAnnotations: props.disableDefaultActionForTappedAnnotations === true, configurationJSONString: props.configuration
            ? JSON.stringify(__assign(__assign({}, props.configuration), { 
                ...
                androidUseTextSelectionToolbar: !!props.textSelectionContextualMenu }))
            : undefined, toolbarJSONString: props.toolbar ? JSON.stringify(props.toolbar) : undefined, menuItemGroupingJSONString: props.menuItemGrouping
