...
var Forms = /** @class */ (function () {
     ...
     * @returns { Promise<boolean> } A promise containing the result of the operation.
     */
    Forms.prototype.setFormFieldReadOnly = function (fullyQualifiedName, readOnly) {
        return react_native_1.NativeModules.PDFDocumentManager.setFormFieldReadOnly((0, react_native_1.findNodeHandle)(this.pdfViewRef), fullyQualifiedName, readOnly);
    };
    /**
     ...
     */
    Forms.prototype.addElectronicSignatureFormField = function (configuration) {
        ...
        return react_native_1.NativeModules.PDFDocumentManager.addElectronicSignatureFormField((0, react_native_1.findNodeHandle)(this.pdfViewRef), {
