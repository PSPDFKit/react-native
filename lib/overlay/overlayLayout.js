...
exports.OVERLAY_SUBSCRIBE_GAVE_UP = void 0;
exports.shouldResubscribeOverlay = shouldResubscribeOverlay;
exports.isPullCurrent = isPullCurrent;
exports.computeOverlayItemScreenPoint = computeOverlayItemScreenPoint;
 ...
 */
exports.OVERLAY_SUBSCRIBE_GAVE_UP = { subscribeGaveUp: true };
/**
 ...
 */
function shouldResubscribeOverlay(currentView, subscribedView) {
    return (currentView !== null && currentView !== void 0 ? currentView : null) !== (subscribedView !== null && subscribedView !== void 0 ? subscribedView : null);
}
/**
 ...
 */
function isPullCurrent(cancelled, generation, currentGeneration) {
 ...
 * both platforms.
 */
function computeOverlayItemScreenPoint(position, pageIndex, viewport) {
    if (!viewport || pageIndex !== viewport.pageIndex) {
        return null;
    }
    var scale = viewport.pdfToScreenScale, pageSize = viewport.pageSize, contentOffset = viewport.contentOffset;
