...
var PDFDocument = /** @class */ (function () {
    ...
    PDFDocument.prototype.getRef = function () {
        if ((0, ArchitectureDetector_1.isNewArchitectureEnabled)()) {
            return this.pdfViewRef;
        }
        return (0, react_native_1.findNodeHandle)(this.pdfViewRef);
    };
    /**
     * @private
     ...
     */
    PDFDocument.prototype.setRotationOffset = function (pageIndex, rotation) {
        return react_native_1.NativeModules.PDFDocumentManager.setRotationOffset(this.getRef(), pageIndex, rotation);
    };
    /**
     ...
     */
    PDFDocument.prototype.clearSelectedAnnotations = function () {
        var ref = this.getRef();
        if (ref == null) {
            return Promise.reject(new Error('PDF view reference is not available'));
        }
        return react_native_1.NativeModules.PDFDocumentManager.clearSelectedAnnotations(ref);
    };
    /**
     ...
     */
    PDFDocument.prototype.selectAnnotations = function (annotations, showContextualMenu) {
        var ref = this.getRef();
        if (ref == null) {
            return Promise.reject(new Error('PDF view reference is not available'));
        }
        return react_native_1.NativeModules.PDFDocumentManager.selectAnnotations(ref, annotations, showContextualMenu !== null && showContextualMenu !== void 0 ? showContextualMenu : false);
    };
    /**
