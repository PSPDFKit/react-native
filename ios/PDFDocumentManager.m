...
RCT_EXTERN_METHOD(setRotationOffset:(NSNumber _Nonnull)reference pageIndex:(NSInteger)pageIndex rotation:(NSInteger)rotation onSuccess:(RCTPromiseResolveBlock)resolve onError:(RCTPromiseRejectBlock)reject);
