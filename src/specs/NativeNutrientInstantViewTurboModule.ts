...
// Same spec as NativeNutrientViewTurboModule for API parity. Instant view uses a separate registry.
...
export default TurboModuleRegistry.getEnforcing<Spec>('NutrientInstantViewTurboModule');
