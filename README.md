...
12. Initialise the windows project: `react-native windows`.
...
16. If the settings windows opens, click on `Developer` and select `yes`.
...
23. Press Yes when Power shell wants to run.
